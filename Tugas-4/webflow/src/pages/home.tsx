...
const Home = () => {
    return (
        <div className="w-auto h-auto flex flex-col gap-40">
            <div
                className="h-[700px] bg-[#C7D0D9] flex relative items-center justify-center overflow-hidden select-none">
            ...
            <div className="max-w-full grid grid-cols-3 ps-20 pe-20 gap-40">
                <p className="text-[40px] text-[#0B0C0E] font-medium">About</p>
                <p className="col-span-2 text-[27px] text-[#3C3D3E] font-normal">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                    et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
                    aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
                    cillum dolore eu fugiat nulla pariatur.
                </p>
                <p className="text-[40px] text-[#0B0C0E] font-medium">Recent Work</p>
                ...
                <p className="text-[40px] text-[#0B0C0E] font-medium">Testimonials</p>
